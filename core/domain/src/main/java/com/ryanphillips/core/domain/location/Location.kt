package com.ryanphillips.core.domain.location
...
data class Location(
    ...
    /**
     * Given that Location stores Lat and Long, we can leverage
     * the existing formula to measure the distance between two Locations
     * on Earth.
     */
